...
var style__0 = function(feature, resolution){
    ...
    var value = feature.get("متوسط درجة الحراره الكبرى");
    var labelText = "";
    size = 0;
    ...
    if (value >= 19.900000 && value <= 29.880000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 29.880000 && value <= 30.360000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 30.360000 && value <= 34.140000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.140000 && value <= 34.820000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.820000 && value <= 35.400000) {
            style = [ new ol.style.Style({
